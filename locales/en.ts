export const en = {
  ...
  sponsors: {
    ...
    platinum: [
      ...
      { name: 'TAHZAN', logo: './sponsors/platinum/NS_踏山TAHZAN_Logo-OG4.png', desc: '' },
      ...
      { name: 'One More Shot Studio', logo: './sponsors/platinum/再一顆影像.png', desc: '' },
      { name: 'Yi Li Xing Steel', logo: './sponsors/platinum/易利興鋼鐵有限公司.png', desc: '' },
      { name: 'Squid Taro', logo: './sponsors/platinum/魷太郎LOGO-02.png', desc: '' },
    ...
    gold: [
      ...
      { name: 'Kendama Master Screw', logo: './sponsors/gold/劍玉師小螺絲.png' },
      { name: 'Chiao Bar', logo: './sponsors/gold/喬吧 傳統整復推拿.png' },
      { name: 'Ozora Kendama', logo: './sponsors/gold/大空 Ozora Kendamao.png' },
      { name: 'Mixskate', logo: './sponsors/gold/板塊運動 Mixskate.png' },
      { name: 'Mystery Dog', logo: './sponsors/gold/神秘狗.png' },
      { name: 'Super Friend Kendama Candy', logo: './sponsors/gold/超朋友劍玉糖.png' },
    ] as { name: string; logo: string; url?: string }[],
    silver: [
      { name: '3 Eyes Girl', logo: './sponsors/silver/3 eyes girl 三眼女孩.png' },
      ...
      { name: 'Li Ting Plumbing', logo: './sponsors/silver/力廷水電工程行.png' },
      { name: 'Xun Nan Dumplings', logo: './sponsors/silver/勳男水餃.png' },
      { name: 'Mountain Castle Egg Cake', logo: './sponsors/silver/山城燒雞蛋糕.png' },
      { name: 'Baifu Kendama', logo: './sponsors/silver/百福劍球.png' },
    ] as { name: string; logo: string; url?: string }[]
  },
  venue: {
